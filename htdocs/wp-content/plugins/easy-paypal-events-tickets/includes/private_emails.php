		...
		if ($valuea['send_customer_email'] == "1" && $send_customer_email == "1") {
			...
			$admin_email = get_bloginfo('admin_email');
			 ...
			 if ($send_customer_email_test == "1") {
				...
				$event_name = "Test Event Name";
				$post_id = "001";
				$qr_code = "<img src='https://chart.googleapis.com/chart?chs=150x150&cht=qr&chl=https%3A%2F%2Fexample.com%2Fwp-admin%2Fadmin-post.php%3Faction%3Dadd_wpeevent_button_qr%26order%3D1321%7C1321%7C53bba04f89b048277a00ac3bb7f85dbf&choe=UTF-8' />";
			 }
